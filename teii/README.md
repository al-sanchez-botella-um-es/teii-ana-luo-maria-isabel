...
jq -C < IBM.json | less -R # Para visualizar resultado
```
...
`TIME_SERIES_WEEKLY_ADJUSTED` para el *ticker* `IBM`. A continuación,
...
- [Python Documentation • `json` — JSON encoder and decoder](https://docs.python.org/3.11/library/json.html)
